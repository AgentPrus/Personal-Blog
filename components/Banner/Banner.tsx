...
const Banner = () => {
    return (
        <div className="text-center">
            ...
            <Link href="/blog">
                <a className="w-full no-underline sm:w-auto flex-none text-lg leading-6 font-semibold py-3 px-6 border border-transparent rounded-xl  focus:outline-none transition-colors duration-200 text-white bg-sky-500 hover:bg-sky-400 dark:bg-sky-400 dark:hover:bg-sky-600">
                    Read all posts
                </a>
            </Link>
        </div>
